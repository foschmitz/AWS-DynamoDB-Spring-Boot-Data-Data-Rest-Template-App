 ...
 * 
 * The resource server is located at "/estate", and can be accessed only by retrieving a token from "/oauth/token" using
...
public class OAuth2SecurityConfiguration {
	...
	/**
	 * This method is used to configure who is allowed to access which parts of our resource server (i.e. the "/estate"
	 * endpoint)
	 */
	@Configuration
	...
	protected static class ResourceServer extends ResourceServerConfigurerAdapter {
		...
		// all of the paths in the estate service.
		@Override
	...
	protected static class OAuth2Config extends AuthorizationServerConfigurerAdapter {
		 ...
		 * updating the EstateSvcClientApiTest.
		 * 
		 * @param auth
		 * @throws Exception
		 */
		public OAuth2Config() throws Exception {
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
					...
					.scopes("read").resourceIds("estate").accessTokenValiditySeconds(3600).and().build();
